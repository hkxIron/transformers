...
class MiniCPMAttention(nn.Module):
    ...
    def __init__(self, config: MiniCPMConfig, layer_idx: Optional[int] = None):
        ...
        self.num_key_value_groups = self.num_heads // self.num_key_value_heads # 每个group size有多大
    ...
    def forward(
        ...
        **kwargs,
        ...
        cos, sin = self.rotary_emb.forward(value_states.to(torch.float32), seq_len=kv_seq_len)
